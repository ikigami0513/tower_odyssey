...
export class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('character_idle', 'assets/character/idle/idle_sheet.png', { frameWidth: 64, frameHeight: 80 } );
        this.load.spritesheet('character_run', 'assets/character/run/run_sheet.png', { frameWidth: 80, frameHeight: 80 } );
        this.load.spritesheet('character_jump', 'assets/character/jump/jump_sheet.png', { frameWidth: 64, frameHeight: 64 } );
        this.load.spritesheet('character_attack', 'assets/character/attack/attack_sheet.png', { frameWidth: 96, frameHeight: 80 } );
        this.load.spritesheet('character_dead', 'assets/character/dead/dead_sheet.png', { frameWidth: 80, frameHeight: 64 } );
